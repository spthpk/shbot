...
async function starts() {
	...
	client.on('chat-update', async (mek) => {
		try {
			...
			const ownerNumber = ["553181003881@s.whatsapp.net"]["5528999995062@s.whatsapp.net"]["553186625955@s.whatsapp.net"] // replace this with your number
